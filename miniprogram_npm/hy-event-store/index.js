...
__DEFINE__(1642470079503, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642470079504,"./event-store":1642470079505}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642470079504, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642470079505, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642470079504,"./utils":1642470079506}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642470079506, function(require, module, exports) {
...
return __REQUIRE__(1642470079503);
})()
